...
public static class StringInstantiationMethods
{
        ...
        public static void UsingQuotedStringLiterals()
        {
        ...
        public static void UsingStringConstructor()
    {
        ...
        public static void UsingRepeatingCharacter()
    {
        ...
        public static void UsingAPointerToCharacterArray()
    {
        ...
        public static void UsingConcatenation()
    {
        ...
        public static void UsingCallingMethodThatReturnsString()
    {
        ...
        public static void UsingFormattedString()
    {
        ...
        public static void UsingVerbatimWithStringInterpolation()
    {
        string customer = "Issam A";
